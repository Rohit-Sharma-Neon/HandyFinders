...
import 'newest_items_model.dart';
export 'newest_items_model.dart';
...
class NewestItemsWidget extends StatefulWidget {
  ...
  static String routeName = 'NewestItems';
  static String routePath = '/newestItems';
...
class _NewestItemsWidgetState extends State<NewestItemsWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NewestItemsModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.saleItemListResponse =
          await HandyFindersAPIsGroup.allSaleItemLIstCall.call(
      ...
      safeSetState(() {});
      if (HandyFindersAPIsGroup.allSaleItemLIstCall.apiStatus(
        (_model.saleItemListResponse?.jsonBody ?? ''),
      )!) {
        _model.itemsList = HandyFindersAPIsGroup.allSaleItemLIstCall
            .apiList(
              (_model.saleItemListResponse?.jsonBody ?? ''),
            )!
            .toList()
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              HandyFindersAPIsGroup.allSaleItemLIstCall.apiMessage(
                (_model.saleItemListResponse?.jsonBody ?? ''),
              )!,
              style: TextStyle(
                  ...
                  builder: (context) {
                    if (_model.isFetchingApi) {
                      ...
                      return RefreshIndicator(
                        key: Key('RefreshIndicator_y1ed69k6'),
                        onRefresh: () async {
                          _model.currentPageIndex = 1;
                          _model.refreshedSaleItemListResponse =
                              await HandyFindersAPIsGroup.allSaleItemLIstCall
                                  .call(
                            authToken: FFAppState().authToken,
                            page: _model.currentPageIndex,
                            type: widget.type,
                          ...
                          if (HandyFindersAPIsGroup.allSaleItemLIstCall
                              .apiStatus(
                            (_model.refreshedSaleItemListResponse?.jsonBody ??
                                ''),
                          )!) {
                            _model.itemsList =
                                HandyFindersAPIsGroup.allSaleItemLIstCall
                                    .apiList(
                                      (_model.refreshedSaleItemListResponse
                                              ?.jsonBody ??
                                          ''),
                                      ...
                                      child: wrapWithModel(
                                        ...
                                        child: BaseButtonComponentWidget(
                                          ...
                                          passOnTapCallback: () async {
                                            ...
                                            safeSetState(() {});
                                            _model.loadMoreSaleItemListResponse =
                                                await HandyFindersAPIsGroup
                                                    .allSaleItemLIstCall
                                                    .call(
                                              authToken: FFAppState().authToken,
