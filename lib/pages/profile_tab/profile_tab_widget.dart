...
class _ProfileTabWidgetState extends State<ProfileTabWidget> {
  ...
  void initState() {
    ...
    _model.switchValue = FFAppState().notificationStatus;
  }
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  FFAppState().userDetailsAppState.username,
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                                        fontFamily: 'Comfortaa',
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: InkWell(
                              ...
                              highlightColor: Colors.transparent,
                              onTap: () async {
                                context.pushNamed(YourPostWidget.routeName);
                              },
                              child: Container(
                                decoration: BoxDecoration(),
                                child: Column(
                          ...
                          InkWell(
                            ...
                            onTap: () async {
                              context
                                  .pushNamed(ReviewAndRatingsWidget.routeName);
                            },
                            child: Container(
                              decoration: BoxDecoration(),
                              child: Column(
