...
import '/index.dart';
import 'your_listing_widget.dart' show YourListingWidget;
import 'package:flutter/material.dart';

class YourListingModel extends FlutterFlowModel<YourListingWidget> {
  ...
  // Stores action output result for [Backend Call - API (User Listing)] action in YourListing widget.
  ApiCallResponse? initialItemListingResponse;
  // Model for IcBackTitle component.
  late IcBackTitleModel icBackTitleModel;
  // Stores action output result for [Backend Call - API (User Listing)] action in Container widget.
  ...
  // Stores action output result for [Backend Call - API (Remove Item)] action in Container widget.
  ...
  // Stores action output result for [Backend Call - API (Remove Item)] action in Container widget.
  ApiCallResponse? removeServiceResponse;
  // Model for BaseButtonComponent component.
