                        ...
                        builder: (context) {
                          if (_model.isPrimaryApiFetching) {
                            ...
                            return RefreshIndicator(
                              key: Key('RefreshIndicator_15bi4n5y'),
                              onRefresh: () async {
                                _model.isPrimaryApiFetching = true;
                                safeSetState(() {});
                                                          ...
                                                          child:
                                                            ...
                                                            passOnTapCallback:
                                                              ...
                                                              if (FFAppState()
                                                                ...
                                                                safeSetState(
                                                                    () {});
                                                                _model.primaryLoadMoreResponse =
                                                                    await HandyFindersAPIsGroup
                                                                        .requestBottomTabCall
                                                                        .call(
                                                                  authToken:
                      ...
                      Builder(
                        builder: (context) {
                          if (_model.isSecondaryApiFetching) {
                            ...
                            return RefreshIndicator(
                              key: Key('RefreshIndicator_2o49urnx'),
                              onRefresh: () async {
                                _model.isSecondaryApiFetching = true;
                                safeSetState(() {});
                                ...
                                if (HandyFindersAPIsGroup.requestBottomTabCall
                                  ...
                                  FFAppState().requestTabCompletedList =
                                      HandyFindersAPIsGroup.requestBottomTabCall
                                          ...
                                          .toList()
                                          .cast<dynamic>();
                                  FFAppState().requestTabSecondaryPageIndex = 2;
                                  safeSetState(() {});
                                  return;
                                } else {
                                  ScaffoldMessenger.of(context)
                                                          ...
                                                          child:
                                                            ...
                                                            passOnTapCallback:
                                                              ...
                                                              if (FFAppState()
                                                                ...
                                                                safeSetState(
                                                                    () {});
                                                                _model.loadMoreSecondaryResponse =
                                                                    await HandyFindersAPIsGroup
                                                                        .requestBottomTabCall
                                                                        .call(
                                                                  authToken:
