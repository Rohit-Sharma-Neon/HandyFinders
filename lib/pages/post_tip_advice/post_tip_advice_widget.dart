...
import 'post_tip_advice_model.dart';
export 'post_tip_advice_model.dart';

class PostTipAdviceWidget extends StatefulWidget {
  const PostTipAdviceWidget({super.key});

  static String routeName = 'PostTipAdvice';
  static String routePath = '/postTipAdvice';

  @override
  State<PostTipAdviceWidget> createState() => _PostTipAdviceWidgetState();
}

class _PostTipAdviceWidgetState extends State<PostTipAdviceWidget> {
  late PostTipAdviceModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PostTipAdviceModel());
                              ...
                              Align(
                                ...
                                child: Padding(
                                  ...
                                  child: wrapWithModel(
                                    ...
                                    updateCallback: () => safeSetState(() {}),
                                    child: TextFieldLabelTextWidget(
                                      labelText: 'Tip/Advice Description',
                                    ),
                                  ),
                                ),
                              ),
                                    ...
                                    return Padding(
                                      ...
                                      child: FlutterFlowDropDown<String>(
                                        ...
                                        onChanged: (val) => safeSetState(() =>
                                            _model.selectedDropDownValue = val),
                                        width: double.infinity,
                                        height: 55.0,
                                        searchHintTextStyle:
                ...
                child: wrapWithModel(
                  ...
                  child: BaseButtonComponentWidget(
                    ...
                    passOnTapCallback: () async {
                      ...
                      if (_model.selectedDropDownValue == null) {
                      ...
                      _model.addTipResponse = await HandyFindersAPIsGroup
                          .addUpdateRequestTipCall
                          .call(
                        authToken: FFAppState().authToken,
                        title: _model.textController1.text,
                        type: 'tip',
                        categoryId: _model.selectedDropDownValue,
                      ...
                      if (HandyFindersAPIsGroup.addUpdateRequestTipCall
                          .apiStatus(
                        (_model.addTipResponse?.jsonBody ?? ''),
                      )!) {
                        context.safePop();
                        context.safePop();
                        ScaffoldMessenger.of(context).clearSnackBars();
